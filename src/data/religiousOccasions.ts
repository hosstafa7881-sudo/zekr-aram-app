...
export const RELIGIOUS_OCCASIONS: ReligiousOccasion[] = [
  { id: 'milad-payambar', hijriMonth: 3, hijriDay: 17, title: 'میلاد پیامبر اکرم (ص) و امام صادق (ع)', personName: 'پیامبر اکرم (ص)', type: 'birth' },
  ...
  { id: 'shahadat-payambar-imam-hassan', hijriMonth: 2, hijriDay: 28, title: 'شهادت پیامبر اکرم (ص) و امام حسن مجتبی (ع)', personName: 'پیامبر اکرم (ص)', type: 'martyrdom' },
  { id: 'shahadat-imam-ali', hijriMonth: 9, hijriDay: 21, title: 'شهادت امام علی (ع)', personName: 'امام علی (ع)', type: 'martyrdom' },
  { id: 'shahadat-fatemeh', hijriMonth: 1, hijriDay: 3, title: 'شهادت حضرت فاطمه زهرا (س)', personName: 'حضرت فاطمه زهرا (س)', type: 'martyrdom' },
  { id: 'ashura', hijriMonth: 1, hijriDay: 10, title: 'شهادت امام حسین (ع) در روز عاشورا', personName: 'امام حسین (ع)', type: 'martyrdom' },
  { id: 'tasua', hijriMonth: 1, hijriDay: 9, title: 'تاسوعای حسینی', personName: 'امام حسین (ع)', type: 'martyrdom' },
  { id: 'arbaeen', hijriMonth: 2, hijriDay: 20, title: 'اربعین حسینی', personName: 'امام حسین (ع)', type: 'martyrdom' },
  ...
  { id: 'shahadat-imam-sadiq', hijriMonth: 7, hijriDay: 25, title: 'شهادت امام جعفر صادق (ع)', personName: 'امام جعفر صادق (ع)', type: 'martyrdom' },
  { id: 'shahadat-imam-kazim', hijriMonth: 7, hijriDay: 25, title: 'شهادت امام موسی کاظم (ع)', personName: 'امام موسی کاظم (ع)', type: 'martyrdom' },
  { id: 'shahadat-imam-reza', hijriMonth: 2, hijriDay: 30, title: 'شهادت امام رضا (ع)', personName: 'امام رضا (ع)', type: 'martyrdom' },
  { id: 'shahadat-imam-jawad', hijriMonth: 12, hijriDay: 29, title: 'شهادت امام محمدتقی الجواد (ع)', personName: 'امام محمدتقی الجواد (ع)', type: 'martyrdom' },
  ...
  { id: 'shahadat-imam-askari', hijriMonth: 8, hijriDay: 8, title: 'شهادت امام حسن عسکری (ع)', personName: 'امام حسن عسکری (ع)', type: 'martyrdom' },
  { id: 'eid-fitr', hijriMonth: 10, hijriDay: 1, title: 'عید سعید فطر', personName: '', type: 'eid' },
  { id: 'eid-ghadir', hijriMonth: 12, hijriDay: 18, title: 'عید سعید غدیر خم', personName: '', type: 'eid' },
  { id: 'eid-mabath', hijriMonth: 7, hijriDay: 27, title: 'عید مبعث پیامبر اکرم (ص)', personName: '', type: 'eid' },
  { id: 'eid-adha', hijriMonth: 12, hijriDay: 10, title: 'عید سعید قربان', personName: '', type: 'eid' },
  { id: 'nimeh-shaban', hijriMonth: 8, hijriDay: 15, title: 'جشن نیمهٔ شعبان (میلاد امام زمان عج)', personName: 'امام زمان (عج)', type: 'eid' },
];
