...
//
// Bumped by one on every review round (round 9 → ۹). Two things read it:
...
/** "نسخه‌ی ۹" — already localized with a Persian digit. */
export const APP_VERSION_LABEL = 'نسخه‌ی ۹';
