...
//
// Bumped by one on every review round (round 7 → ۷). Two things read it:
...
/** "نسخه‌ی ۷" — already localized with a Persian digit. */
export const APP_VERSION_LABEL = 'نسخه‌ی ۷';
