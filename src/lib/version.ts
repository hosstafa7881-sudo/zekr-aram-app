...
//
// Bumped by one on every review round (round 8 → ۸). Two things read it:
...
/** "نسخه‌ی ۸" — already localized with a Persian digit. */
export const APP_VERSION_LABEL = 'نسخه‌ی ۸';
