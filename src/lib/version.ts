...
//
// Bumped by one on every review round (round 10 → ۱۰). Two things read it:
...
/** "نسخه‌ی ۱۰" — already localized with a Persian digit. */
export const APP_VERSION_LABEL = 'نسخه‌ی ۱۰';
